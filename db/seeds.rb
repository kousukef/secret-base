...
books =     [{children: '教科書', grandchildren: ['教科書（経営学部）', '教科書（経済学部）', '教科書（コミュニケーション学部）',
                                                  '教科書（現代法学部）','教科書（その他）']},
             {children: '参考書'},
             {children: '漫画',   grandchildren: ['少年漫画', '青年漫画', '少女漫画']},
             {children: '雑誌'},
             {children: '小説'},
             {children: 'ビジネス書'},
             {children: 'その他'}]

mens =      [{children: '服', grandchildren: ['トップス', 'ジャケット/アウター', 'パンツ', 'その他']},
             {children: '靴', grandchildren: ['革靴', 'スニーカー', 'サンダル', 'その他']},
...
ledys =     [{children: '服', grandchildren: ['トップス', 'ジャケット/アウター', 'パンツ', 'その他']},
             {children: '靴', grandchildren: ['革靴', 'スニーカー', 'サンダル', 'その他']},
             {children: 'カバン', grandchildren: ['リュック', 'トートバッグ', 'ショルダーバッグ', 'ボストンバッグ', 'ボディーバッグ',
                                                 'ビジネスバッグ', 'その他']},
             {children: 'アクセサリー'},
...
gadgets =   [{children: 'スマホアクセサリー'},
             {children: 'PC'},
             {children: 'カメラ'},
             {children: 'オーディオ機器', grandchildren: ['イヤホン', 'ヘッドホン', 'スピーカー', 'ポータブルプレーヤー', 'その他']},
             {children: 'その他'}]
